import{a6 as T,aH as P,aa as x,aB as N,bm as m,g as K,v as c,x as i,y as l,J as h,aZ as z,av as r,G as b,aw as y,M as f,N as v,A as O,bn as S}from"./DiLWiPl0.js";var $=({dt:e})=>`
...
`,B={root:"p-organizationchart p-component",table:"p-organizationchart-table",node:function(n){var o=n.instance;return["p-organizationchart-node",{"p-organizationchart-node-selectable":o.selectable,"p-organizationchart-node-selected":o.selected}]},nodeToggleButton:"p-organizationchart-node-toggle-button",nodeToggleButtonIcon:"p-organizationchart-node-toggle-button-icon",connectors:"p-organizationchart-connectors",connectorDown:"p-organizationchart-connector-down",connectorLeft:function(n){var o=n.index;return["p-organizationchart-connector-left",{"p-organizationchart-connector-top":o!==0}]},connectorRight:function(n){var o=n.props,a=n.index;return["p-organizationchart-connector-right",{"p-organizationchart-connector-top":a!==o.node.children.length-1}]},nodeChildren:"p-organizationchart-node-children"},j=T.extend({name:"organizationchart",style:$,classes:B}),D={name:"BaseOrganizationChart",extends:N,props:{value:{type:null,default:null},selectionKeys:{type:null,default:null},selectionMode:{type:String,default:null},collapsible:{type:Boolean,default:!1},collapsedKeys:{type:null,default:null}},style:j,provide:function(){return{$pcOrganizationChart:this,$parentInstance:this}}},w={name:"OrganizationChartNode",hostName:"OrganizationChart",extends:N,emits:["node-click","node-toggle"],props:{node:{type:null,default:null},templates:{type:null,default:null},collapsible:{type:Boolean,default:!1},collapsedKeys:{type:null,default:null},selectionKeys:{type:null,default:null},selectionMode:{type:String,default:null}},methods:{getPTOptions:function(n){return this.ptm(n,{context:{expanded:this.expanded,selectable:this.selectable,selected:this.selected,toggleable:this.toggleable,active:this.selected}})},getNodeOptions:function(n,o){return this.ptm(o,{context:{lineTop:n}})},onNodeClick:function(n){m(n.target,"data-pc-section","nodetogglebutton")||m(n.target,"data-pc-section","nodetogglebuttonicon")||this.selectionMode&&this.$emit("node-click",this.node)},onChildNodeClick:function(n){this.$emit("node-click",n)},toggleNode:function(){this.$emit("node-toggle",this.node)},onChildNodeToggle:function(n){this.$emit("node-toggle",n)},onKeydown:function(n){(n.code==="Enter"||n.code==="NumpadEnter"||n.code==="Space")&&(this.toggleNode(),n.preventDefault())}},computed:{leaf:function(){return this.node.leaf===!1?!1:!(this.node.children&&this.node.children.length)},colspan:function(){return this.node.children&&this.node.children.length?this.node.children.length*2:null},childStyle:function(){return{visibility:!this.leaf&&this.expanded?"inherit":"hidden"}},expanded:function(){return this.collapsedKeys[this.node.key]===void 0},selectable:function(){return this.selectionMode&&this.node.selectable!==!1},selected:function(){return this.selectable&&this.selectionKeys&&this.selectionKeys[this.node.key]===!0},toggleable:function(){return this.collapsible&&this.node.collapsible!==!1&&!this.leaf}},components:{ChevronDownIcon:x,ChevronUpIcon:P}},M=["colspan"],I=["colspan"],E=["colspan"];function L(e,n,o,a,s,t){var p=K("OrganizationChartNode",!0);return i(),c("table",r({class:e.cx("table")},e.ptm("table")),[l("tbody",z(S(e.ptm("body"))),[o.node?(i(),c("tr",z(r({key:0},e.ptm("row"))),[l("td",r({colspan:t.colspan},e.ptm("cell")),[l("div",r({class:[e.cx("node"),o.node.styleClass],onClick:n[2]||(n[2]=function(){return t.onNodeClick&&t.onNodeClick.apply(t,arguments)})},t.getPTOptions("node")),[(i(),b(y(o.templates[o.node.type]||o.templates.default),{node:o.node},null,8,["node"])),t.toggleable?(i(),c("a",r({key:0,tabindex:"0",class:e.cx("nodeToggleButton"),onClick:n[0]||(n[0]=function(){return t.toggleNode&&t.toggleNode.apply(t,arguments)}),onKeydown:n[1]||(n[1]=function(){return t.onKeydown&&t.onKeydown.apply(t,arguments)})},t.getPTOptions("nodeToggleButton")),[o.templates.toggleicon||o.templates.togglericon?(i(),b(y(o.templates.toggleicon||o.templates.togglericon),r({key:0,expanded:t.expanded,class:e.cx("nodeToggleButtonIcon")},t.getPTOptions("nodeToggleButtonIcon")),null,16,["expanded","class"])):(i(),b(y(t.expanded?"ChevronDownIcon":"ChevronUpIcon"),r({key:1,class:e.cx("nodeToggleButtonIcon")},t.getPTOptions("nodeToggleButtonIcon")),null,16,["class"]))],16)):h("",!0)],16)],16,M)],16)):h("",!0),l("tr",r({style:t.childStyle,class:e.cx("connectors")},e.ptm("connectors")),[l("td",r({colspan:t.colspan},e.ptm("lineCell")),[l("div",r({class:e.cx("connectorDown")},e.ptm("connectorDown")),null,16)],16,I)],16),l("tr",r({style:t.childStyle,class:e.cx("connectors")},e.ptm("connectors")),[o.node.children&&o.node.children.length===1?(i(),c("td",r({key:0,colspan:t.colspan},e.ptm("lineCell")),[l("div",r({class:e.cx("connectorDown")},e.ptm("connectorDown")),null,16)],16,E)):h("",!0),o.node.children&&o.node.children.length>1?(i(!0),c(f,{key:1},v(o.node.children,function(g,u){return i(),c(f,{key:g.key},[l("td",r({class:e.cx("connectorLeft",{index:u}),ref_for:!0},t.getNodeOptions(u!==0,"connectorLeft"))," ",16),l("td",r({class:e.cx("connectorRight",{index:u}),ref_for:!0},t.getNodeOptions(u!==o.node.children.length-1,"connectorRight"))," ",16)],64)}),128)):h("",!0)],16),l("tr",r({style:t.childStyle,class:e.cx("nodeChildren")},e.ptm("nodeChildren")),[(i(!0),c(f,null,v(o.node.children,function(g){return i(),c("td",r({key:g.key,colspan:"2",ref_for:!0},e.ptm("nodeCell")),[O(p,{node:g,templates:o.templates,collapsedKeys:o.collapsedKeys,onNodeToggle:t.onChildNodeToggle,collapsible:o.collapsible,selectionMode:o.selectionMode,selectionKeys:o.selectionKeys,onNodeClick:t.onChildNodeClick,pt:e.pt,unstyled:e.unstyled},null,8,["node","templates","collapsedKeys","onNodeToggle","collapsible","selectionMode","selectionKeys","onNodeClick","pt","unstyled"])],16)}),128))],16)],16)],16)}w.render=L;function d(e){"@babel/helpers - typeof";return d=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(n){return typeof n}:function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},d(e)}function k(e,n){var o=Object.keys(e);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(e);n&&(a=a.filter(function(s){return Object.getOwnPropertyDescriptor(e,s).enumerable})),o.push.apply(o,a)}return o}function C(e){for(var n=1;n<arguments.length;n++){var o=arguments[n]!=null?arguments[n]:{};n%2?k(Object(o),!0).forEach(function(a){R(e,a,o[a])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(o)):k(Object(o)).forEach(function(a){Object.defineProperty(e,a,Object.getOwnPropertyDescriptor(o,a))})}return e}function R(e,n,o){return(n=A(n))in e?Object.defineProperty(e,n,{value:o,enumerable:!0,configurable:!0,writable:!0}):e[n]=o,e}function A(e){var n=V(e,"string");return d(n)=="symbol"?n:n+""}function V(e,n){if(d(e)!="object"||!e)return e;var o=e[Symbol.toPrimitive];if(o!==void 0){var a=o.call(e,n);if(d(a)!="object")return a;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(e)}var U={name:"OrganizationChart",extends:D,inheritAttrs:!1,emits:["node-unselect","node-select","update:selectionKeys","node-expand","node-collapse","update:collapsedKeys"],data:function(){return{d_collapsedKeys:this.collapsedKeys||{}}},watch:{collapsedKeys:function(n){this.d_collapsedKeys=n}},methods:{onNodeClick:function(n){var o=n.key;if(this.selectionMode){var a=this.selectionKeys?C({},this.selectionKeys):{};a[o]?(delete a[o],this.$emit("node-unselect",n)):(this.selectionMode==="single"&&(a={}),a[o]=!0,this.$emit("node-select",n)),this.$emit("update:selectionKeys",a)}},onNodeToggle:function(n){var o=n.key;this.d_collapsedKeys[o]?(delete this.d_collapsedKeys[o],this.$emit("node-expand",n)):(this.d_collapsedKeys[o]=!0,this.$emit("node-collapse",n)),this.d_collapsedKeys=C({},this.d_collapsedKeys),this.$emit("update:collapsedKeys",this.d_collapsedKeys)}},components:{OrganizationChartNode:w}};function q(e,n,o,a,s,t){var p=K("OrganizationChartNode");return i(),c("div",r({class:e.cx("root")},e.ptmi("root")),[O(p,{node:e.value,templates:e.$slots,onNodeToggle:t.onNodeToggle,collapsedKeys:s.d_collapsedKeys,collapsible:e.collapsible,onNodeClick:t.onNodeClick,selectionMode:e.selectionMode,selectionKeys:e.selectionKeys,pt:e.pt,unstyled:e.unstyled},null,8,["node","templates","onNodeToggle","collapsedKeys","collapsible","onNodeClick","selectionMode","selectionKeys","pt","unstyled"])],16)}U.render=q;export{U as default};
