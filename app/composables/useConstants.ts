...
export const locationMap: Record<string, string> = {
  ...
  "和平 誠": `query=${encodeURIComponent("25°01'29.7\"N 121°31'40.6\"E")}&query_place_id=ChIJq-eGZoWpQjQRG6xc6xIKdvk`,
  "和平 正": `query=${encodeURIComponent("25°01'30.4\"N 121°31'40.4\"E")}&query_place_id=ChIJq-eGZoWpQjQRG6xc6xIKdvk`,
  "和平 勤": `query=${encodeURIComponent("25°01'30.8\"N 121°31'36.7\"E")}&query_place_id=ChIJq-eGZoWpQjQRG6xc6xIKdvk`,
  "和平 樸": `query=${encodeURIComponent("25°01'30.8\"N 121°31'36.7\"E")}&query_place_id=ChIJq-eGZoWpQjQRG6xc6xIKdvk`,
